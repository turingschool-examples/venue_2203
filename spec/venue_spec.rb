...
describe Venue do
  ...
  describe '#over_capacity?' do
    it 'returns false under capacity value' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
    ...
    it 'returns true when over capacity value' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
  ...
  describe '#kick_out' do
    it 'removes patrons until patrons is less than capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
    ...
    it "doesn't remove any patrons if fewer than capacity" do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
